...
import PolygonNodeExtension from './canvas-extensions/polygon-node-extension'
...
const CANVAS_EXTENSIONS: typeof CanvasExtension[] = [
  ...
  CustomEdgeConnectionPositionsExtension, // 处理连接线在节点边缘上的精确位置
  CustomEdgeConnectionRendererExtension, // 在节点边缘渲染可交互的连接点
...
export default class AdvancedCanvasPlugin extends Plugin {
  ...
  canvasExtensions: CanvasExtension[]
    ...
    // 注册画布扩展
    // 这些扩展已经在CANVAS_EXTENSIONS中注册了，不需要重复注册
    // this.registerExtensions([
    //   new CanvasLayerExtension(this),
    //   new TableCanvasExtension(this)
    // ])
	}
